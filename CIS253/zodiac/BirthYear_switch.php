...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
        <div id="container">
            ...
            <div id="textr">
                <?php
                    function validateInput($data, $fieldName) { //p. 225 or p. 220 or p. 202 #3
                        global $errorCount;
                        if(empty($data)){
                ...
                <?php	 
                    ...
                    function put_contents($fname, $data) { //p. 271 $fname=$SaveFilename , $data=savestring
                        $retval = true;
                        $fp = fopen($fname, "wb");
                        if ($fp === FALSE) {
                    ...
                    function StatisticsForYear($Year) {//Builds statistics text files
                        $retval = 0;
